    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          <div className="flex h-full w-full flex-col bg-green-800 text-white">{children}</div>
        </SheetContent>
      </Sheet>
    );
  }
...
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 items-center overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props} />
  );
